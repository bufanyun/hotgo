          ...
          <a-row :gutter="48">
            <a-col :md="6" :sm="24">
              <a-form-item label="岗位名称">
                <a-input v-model="queryParam.name" placeholder="请输入岗位名称" allow-clear @keyup.enter.native="handleQuery"/>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24">
              <a-form-item label="岗位编码">
                <a-input v-model="queryParam.code" placeholder="请输入岗位编码" allow-clear @keyup.enter.native="handleQuery"/>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24">
